...
//                TipView *tipView = [[TipView alloc] initWithTitle:@"报告主公" message:@"网络不给力,无法连接服务器"];
//                [tipView addButtonWithTitle:@"取消" action:nil];
//                [tipView show];
                [MBProgressHUD showAlert:@"网络不给力,无法连接服务器" afterDelay:2];
            }
